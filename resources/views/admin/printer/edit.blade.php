...
@section('content')
	...
	{!! BootForm::open()->action(route('printer.update', $printer))->put() !!}
        ...
        {!! BootForm::text('Start Charging Overtime At', 'overtime_start')->helpBlock('If charging an overtime fee, specficy the interval for when the fee should be applied. Value should be in hours.') !!}
